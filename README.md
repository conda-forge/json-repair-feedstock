...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/json-repair-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/json-repair-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add json-repair
# for installing globally
pixi global install json-repair
```
...
It is possible to list all of the versions of `json-repair` available on your platform:
...
```
pixi search json-repair --channel conda-forge
```
